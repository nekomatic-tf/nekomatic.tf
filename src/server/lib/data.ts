...
export const paintCan: { [defindex: string]: string } = {
...
export const paintCans = Object.keys(paintCan);

export const ks1Images: { [target: string]: string } = {
    // Killstreak Kit (6527)
    // Kritzkrieg (5749)
...
export const ks2Images: { [target: string]: string } = {
...
export const ks3Images: { [target: string]: string } = {
...
export const strangifierImages: { [target: string]: string } = {
...
export const unusualifierImages: { [target: string]: string } = {
    // Taunt: The High Five!
...
export const festivizedImages: { [defindex: string]: string } = {
...
export const retiredKeys: { [defindex: string]: string } = {
